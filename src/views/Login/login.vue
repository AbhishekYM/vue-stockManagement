                        ...
                        <div class="row g-0 h-100">
                            <div class="col-md-5 text-center bg-card-gradient">
                                <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                    ...
                                    <div class="z-1 position-relative">
                                        <!-- <img class="me-2" src="/src/assets/img/logos/GIDC.jpg" alt="" /> -->
                                        <p class="opacity-75 text-white">With the power of Stock Management, you can now focus only on functionaries for your digital products, while leaving the UI design on us!</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-7 d-flex flex-center">
                                <div class="p-4 p-md-5 flex-grow-1">
                                    ...
                                    <form @submit.prevent="">
                                        <div class="mb-3"><label class="form-label" for="card-email">Email address</label><input v-model="store.form.email" class="form-control" id="card-email" type="email" /></div>
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between"><label class="form-label" for="card-password">Password</label></div><input v-model="store.form.password" class="form-control" id="card-password" type="password" />
                                        </div>
                                        ...
                                        <div class="mb-3"><button class="btn btn-primary d-block w-100 mt-3" type="submit" @click="store.handleSubmit" name="submit">Log in</button></div>
                                    </form>
                                    <div class="position-relative mt-4">
                                        <hr />
                                        <div class="divider-content-center">or Sign up </div>
                                    </div>
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                                        <p>Don't have an account?<br><a class="text-decoration-underline " href="register.html">Get started!</a></p>
                                        <p class="mb-0 mt-4 mt-md-5 fs-10 fw-semi-bold  opacity-75">Read our <a class="text-decoration-underline " href="#!">terms</a> and <a class="text-decoration-underline " href="#!">conditions </a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
